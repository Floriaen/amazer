	...
	ManBackup = MapEntity.extend({
		...
		handleMovementTrace: function(res) {
			...
			if (res.collision.x || res.collision.y) {
				...
				if ((this.tile.x === this.toTile.x && this.padding.x < 0.2) && (this.tile.y === this.toTile.y && this.padding.y < 0.2)) {
					//this.snapToTile();
				}
...
/*
		...
		kill: function(){
			var deadMan = ig.game.spawnEntity('Skull', this.pos.x, this.pos.y);
